...
<!-- Skill -->
<section class="p-contents p-contents__skill c-backcolor" id="skill">
    <div class="l-container l-container__skill">
...
<!-- end Skill -->
<!-- Contact -->
<section class="p-contents " id="contact">
            ...
            <form action="" method="post">
                <div class="p-contact__form__wrapp">
                    ...
                    <div class="p-contact__form">
                        <input class="c-form js-form-name <?php if (!empty($err_msg['name'])) { echo 'c-error'; } ?>"
                            type="text" name="name" value="<?php echo getFormData('name'); ?>" />
                        <div class="c-error__msg">
                            <?php if (!empty($err_msg['name'])) { echo sanitize('お名前は') . $err_msg['name']; } ?>
                        </div>
                    </div>
                </div>
                <div class="p-contact__form__wrapp">
                    ...
                    <div class="p-contact__form">
                        <input class="c-form <?php if (!empty($err_msg['email'])) { echo 'c-error'; } ?>" type="text"
                            name="email" value="<?php echo getFormData('email'); ?>" />
                        <div class="c-error__msg">
                            <?php if (!empty($err_msg['email'])) { echo sanitize('メールアドレスは') . $err_msg['email']; } ?>
                        </div>
                    </div>
                </div>
                <div class="p-contact__form__wrapp">
                    ...
                    <div class="p-contact__form">
                        <input class="c-form <?php if (!empty($err_msg['subject'])) { echo 'c-error'; } ?>" type="text"
                            name="subject" value="<?php echo getFormData('subject'); ?>" />
                        <div class="c-error__msg">
                            <?php if (!empty($err_msg['subject'])) { echo sanitize('タイトルは') . $err_msg['subject']; } ?>
                        </div>
                    </div>
                </div>
                <div class="p-contact__form__wrapp">
                    ...
                    <div class="p-contact__form">
                        <textarea
                            class="c-form c-form__textarea <?php if (!empty($err_msg['contact'])) { echo 'c-error'; } ?>"
                            type="text" name="contact"><?php echo getFormData('contact'); ?></textarea>
                        <div class="c-error__msg">
                            <?php if (!empty($err_msg['contact'])) { echo sanitize('お問い合わせ内容は') . $err_msg['contact']; } ?>
                        </div>
                    </div>
                </div>
                <button class="c-btn">
