...
?>
    ...
    <div class="l-main">
      ...
      <section class="p-contents p-contents__about" id="about">
        ...
        <div class="c-modal js-profile-modal">
          <div class="c-modal__container">
            <div class="c-modal__body">
              <div class="c-modal__body__inner"></div>
            </div>
          </div>
        </div>
        <!-- end profile detail modal -->
      </section>
      <!-- Work -->
          ...
          <ul class="p-work__wrapp">
            <li class="p-work__card">
              <div class="p-work__card__inner">
                ...
                <div class="p-work__card__detail">
                  ...
                  <div class="p-work__card__meta">SNSを利用した仮想通貨のトレンド分析サービスです。</div>
            ...
            <li class="p-work__card">
              <div class="p-work__card__inner">
                ...
                <div class="p-work__card__detail">
                  ...
                  <div class="p-work__card__meta">付箋の様にタスクを管理できるタスク管理サービスです。</div>
                  <div class="p-work__card__meta">
                    <ul style="display: flex">
                      <li>Laravel</li>
                      <li>Vue.js</li>
            ...
            <li class="p-work__card">
              <div class="p-work__card__inner">
                ...
                <div class="p-work__card__detail">
                  ...
                  <div class="p-work__card__meta">運営している野球チームの公式サイトです。</div>
                  <div class="p-work__card__meta"></div>
                </div>
              </div>
            </li>
            <li class="p-work__card">
              <div class="p-work__card__inner">
                ...
                <div class="p-work__card__detail">
                  ...
                  <div class="p-work__card__meta">野球用品専門のフリーマーケットサービス</div>
                  <div class="p-work__card__meta"></div>
                </div>
              </div>
            </li>
            <li class="p-work__card">
              <div class="p-work__card__inner">
                ...
                <div class="p-work__card__detail">
                  <div class="p-work__card__list"></div>
                </div>
              </div>
            </li>
            <li class="p-work__card">
